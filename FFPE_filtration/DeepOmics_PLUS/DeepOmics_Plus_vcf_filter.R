# ============================================================
# DeepOmics FFPE Plus VCF Filtering Pipeline
# ------------------------------------------------------------
# This script:
# 1. Reads VCF files
...
input_dir     <- "path/to/your/DeepOmics_Plus_vcf_directory"
output_dir    <- "path/to/your/output_directory"
summary_file  <- "path/to/your/output_directory/Deepomics_Plus_artifact_summary.xlsx"
genome_build  <- "hg38"
...
for (vcf_file in vcf_files) {
  ...
  tryCatch({
    ...
    # Filter artifacts
    filtered_vcf <- vcf[info_df$IS_VARIANT == 1, ]
    
    # Count statistics
    removed_artifacts  <- sum(info_df$IS_VARIANT != 1, na.rm = TRUE)
    remaining_variants <- sum(info_df$IS_VARIANT == 1, na.rm = TRUE)
